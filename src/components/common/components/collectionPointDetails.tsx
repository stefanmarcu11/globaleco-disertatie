                        ...
                        <div className="rating-row">
                            ...
                            <div className="rating-bar">
                                <div
                                    ...
                                    style={{ width: `${(ratingBreakdown.excellent / reviews.length) * 100}%` }}
                                ></div>
                            </div>
                        </div>
                        <div className="rating-row">
                            ...
                            <div className="rating-bar">
                                <div
                                    className="rating-fill"
                                    style={{ width: `${(ratingBreakdown.good / reviews.length) * 100}%` }}
                                ></div>
                            </div>
                        </div>
                        <div className="rating-row">
                            ...
                            <div className="rating-bar">
                                <div
                                    className="rating-fill"
                                    style={{ width: `${(ratingBreakdown.average / reviews.length) * 100}%` }}
                                ></div>
                            </div>
                        </div>
                        <div className="rating-row">
                            ...
                            <div className="rating-bar">
                                <div
                                    className="rating-fill"
                                    style={{ width: `${(ratingBreakdown.poor / reviews.length) * 100}%` }}
                                ></div>
                            </div>
                        </div>
                    </div>
